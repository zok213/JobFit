...
import { ArrowLeft, Save, Download, Check } from "lucide-react";
...
export default function CVBuilderPage() {
  ...
  const handleSaveDraft = async () => {
    ...
    setSaveMessage("");
    try {
      // Lấy dữ liệu từ localStorage (CVBuilder đã lưu tự động)
      const cvData = localStorage.getItem('cv-builder-data');
      
      if (cvData) {
        // TODO: Lưu vào Supabase khi có backend
        // await supabase.from('resumes').insert({ data: JSON.parse(cvData), user_id: userId });
